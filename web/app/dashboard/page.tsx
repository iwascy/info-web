  ...
  return (
    <Shell title="总览" subtitle="我的服务现在还活着吗？同步任务进行到哪了？">
      <div className="grid grid-4 mb-20">
        ...
        <MetricCard label="正常运行" value={d?.healthy ?? "—"} note={<>可用率 <span className="t-green tabnum">{d?.uptime_pct ?? 0}%</span></>} tone="green" icon="checkCircle" series={healthySeries} />
